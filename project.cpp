    ...
    do
    {
        ...
        if(strcmp(password, "chintu")==0){
            ...
            do{
                ...
                else if(strcmp(ch, "open cgcclg") == 0){
                    cout<<"openining landran clg....."<<endl;
                    string phrase = "opening clg website";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    system("start https://www.cgc.edu.in/");
                }
